...
export default function Footer() {
    return (
        <div className="w-full border-t-2 md:p-5 p-2 grid md:grid-cols-3 grid-cols-1 font-TwCenMTCondensed border-gray-700">
            <div className="w-full flex md:justify-center">
                <div className="md:mx-auto">
                    <div className="flex flex-col gap-1">
                        <div className="flex gap-2">
                            <div>
                                <p className="text-2xl">AUTO-LAND Piotr Wójcik</p>
                            </div>
                        </div>
                    </div>
                </div>
